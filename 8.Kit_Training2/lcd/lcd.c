...
static void LCD_integerToString(uint8*,uint32);
void LCD_init(void)
{
...
void LCD_displayString(uint8 const*const a_char)
{
...
static void LCD_integerToString(uint8*const string_Ptr,uint32 a_num)
{ uint8 i=0;
