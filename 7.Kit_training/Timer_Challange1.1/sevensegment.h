...
#define SEVENSEGMENT_PORTCATHODE_ID	 				 PORTC_ID
#define SEVENSEGMENT_PINCATHODE_ID					 PIN6_ID
...
#define SEVENSEGMENT_PIN0ID				  			 PIN1_ID
#define SEVENSEGMENT_PIN1ID				  			 PIN2_ID
#define SEVENSEGMENT_PIN2ID				  			 PIN3_ID
#define SEVENSEGMENT_PIN3ID				  			 PIN4_ID
#define SEVENSEGMENT_PIN4ID				  			 PIN5_ID
#define SEVENSEGMENT_PIN5ID				  			 PIN6_ID
#define SEVENSEGMENT_PIN6ID				  			 PIN7_ID
